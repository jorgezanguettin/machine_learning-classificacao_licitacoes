...
@Component({
  selector: 'app-licitacoes-filtradas',
  templateUrl: './licitacoes-filtradas.page.html',
  styleUrls: ['./licitacoes-filtradas.page.scss'],
})
export class LicitacoesFiltradasPage implements OnInit {
  ...
  getAllLicitacoes() {
    this.api.get_all_licitacao_categoria("Agronegocio").subscribe( data => {
